...
public class ProductDBContext extends DBContext {
    ...
    public List<Product> getAllProducts() {
        ...
        try {
            String sql = "select * from product where price < 700";
    ...
    public List<Product> getProductsWithPaggingMinMax(int page, int PAGE_SIZE,double min,double max) {
        List<Product> list = new ArrayList<>();
        try {
            String sql = "select *  from Product" +"where price>="+min+"and price<="+max+ "order by id "+"\n"
                    + "offset (?-1)*? row fetch next ? rows only";
    ...
    public int getTotalProductsMinMax(double min,double max) {
        try {
            String sql = "select count(id)  from Product where price>="+min+"and price<="+max;
